...
var object1; // object1 can only hold values which are objects
// Examples
object1 = {
    name: 'peter rabbit',
    occupation: 'actor'
...
var object2; // now only actual objects can be store in this variable and must have the same structure and defined data types
object2 = {
    name: 'umar bn affan',
    role: 'caliph',
    age: 71,
